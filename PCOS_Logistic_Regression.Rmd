...
```{r}
model_names = c("reduced_sat_model", "no_follicle_no_r", "sig_feat_model1", "sig_feat_model2", "model")
AIC = AIC(reduced_sat_model, no_follicle_no_r, sig_feat_model1, sig_feat_model2, model)
BIC = BIC(reduced_sat_model, no_follicle_no_r, sig_feat_model1, sig_feat_model2, model)
...
R = c(R_reduced_sat_model, R_no_follicle_r, R_sig_feat_model1, R_sig_feat_model2, R_model)
```

```{r}
df1 = data.frame(model_names, R, AIC, BIC)
df1 = select(df1, -c("df.1"))
knitr::kable(df1)
```
